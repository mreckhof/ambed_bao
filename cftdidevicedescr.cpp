...
int CFtdiDeviceDescr::CreateInterface(CFtdiDeviceDescr *descr, std::vector<CVocodecChannel *>*channels)
{
    ...
    else if ( (::strcmp(descr->GetDescription(), "BAOFARM1 A") == 0) ||
	      (::strcmp(descr->GetDescription(), "BAOFARM! A") == 0) )  // Team6160 AMBE3000 x4
    {
...
int CFtdiDeviceDescr::GetNbChannels(void) const
{
    ...
    // four channels devices
    else if ( (::strcmp(m_szDescription, "BAOFARM1 A") == 0) ||
	      (::strcmp(m_szDescription, "BAOFARM! A") == 0) )       // Team6160 AMBE3000 x4
    {
        iNbChs = 4;
    }
    // six channels devices
